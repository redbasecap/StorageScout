    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl font-bold text-primary">StorageScout</CardTitle>
          <CardDescription>Your smart inventory sidekick.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col items-center space-y-6">
            <p className="text-center text-muted-foreground">Sign in to manage your storage boxes.</p>
